...
public class EmailService {
    ...
    @Async("asyncExecutor")
    public void planboardInvite(Planboard planboard, UserEntity owner, UserEntity userEntity,String emailId, String role, Instant start) {
        ...
        if(StringUtils.isEmpty(emailId)){
            String userName=extractNameFromEmail(emailId);
